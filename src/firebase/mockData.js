export const EVENT_INFO = {
  ...
  description: "アート・サウンド・テクノロジーが交差するチルアウトコミュニティラウンジ。大阪・コンピュファンクで不定期にイベントを開催。デジタルポイントでコミュニティ実験中、ご参加ください。",
...
export const INITIAL_ARTISTS = [
  {
    ...
    bio: "【OPENING ACT】クリスタルボウルの神秘的な倍音響が織りなすサウンドヒーリング。五感を満たす空間調整パフォーマンス。",
    totalPoints: 9800,
    likesCount: 120,
...
export const INITIAL_TIPS = [
  {
    ...
    toArtistId: "artist_2",
    toArtistName: "Jun Takayama aka speedometer.",
    amount: 300,
    message: "speedometer.のドロップ最高すぎる！🔥",
  ...
  },
  {
    ...
    fromUserName: "SORA",
    toArtistId: "artist_8",
    toArtistName: "オギミール（Columbia8)",
    amount: 500,
    message: "スパイスグルーヴ最高！Columbia8愛してる！🙌",
  ...
  },
  {
    ...
    fromUserName: "MEGUMI",
    toArtistId: "artist_10",
    toArtistName: "FisH + HIWATASHI",
    amount: 300,
    message: "ライヴペイントとビジュアルの融合が神懸かってる！✨",
